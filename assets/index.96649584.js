...
const showName = (name2) => updateProfile(auth.currentUser, {
  displayName: name2
});
...
const createPost = (comment) => Ql(Ta(db, "posts"), {
  name: auth.currentUser.displayName,
  comment,
  timestamp: rf(),
  uid: auth.currentUser.uid
});
const q = sl(Ta(db, "posts"), hl("timestamp", "desc"));
const print = (comment) => jl(q, comment);
const deletePost = (id2) => {
  Gl(Aa(db, "posts", id2));
};
const getCurrentUser = () => auth.currentUser;
const btnGoogleImg = "/DEV003-social-network/assets/google_1x.cbcbd4c2.png";
const Login = (onNavigate2) => {
  ...
  logIn.textContent = "Inicia sesi\xF3n";
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (emailValue === "" || passwordValue === "") {
      ...
      loginEmail(emailValue, passwordValue).then((userCredential) => {
...
const Wall = (onNavigate2) => {
  ...
  logo.src = logoImg;
  title.textContent = "Escribe el evento ac\xE1:";
  ...
  formPost.addEventListener("submit", (e) => {
    ...
    if (postValue === "") {
      Toastify({
        text: "El post no puede estar vac\xEDo",
        duration: 3e3,
        style: {
...
const Register = (onNavigate2) => {
  ...
  inputEmail.placeholder = "usuario@usuario.com";
  inputEmail.type = "email";
  inputPassword.placeholder = "Crea Contrase\xF1a";
  inputPassword.type = "password";
  inputRePassword.placeholder = "Repite Contrase\xF1a";
  ...
  buttonRegister.addEventListener("click", (e) => {
    ...
    if (nameValue === "") {
      ...
      Toastify({
        text: "La contrase\xF1a no coincide",
        duration: 700,
        style: {
          background: "linear-gradient(to right, #F2BC57, #F24495)"
        }
      ...
      registerUser(emailValue, passwordValue).then((userCredential) => {
        const user = userCredential.user;
        console.log(user);
        sendEmail().then(() => {
          showName(nameValue).then(() => {
            Toastify({
